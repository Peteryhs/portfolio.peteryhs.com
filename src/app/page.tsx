...
export default function Page() {
  return (
    <div className="relative min-h-screen w-full">
      ...
      <main className="relative z-1 flex flex-col min-h-[100dvh] space-y-10">
        <section id="hero">
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                    What I Have Built So{" "}
                    <span className="bg-gradient-to-r from-blue-400 to-green-600 inline-block text-transparent bg-clip-text">
                      Far
                    </span>
                  </h2>
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    I&apos;ve worked on a variety of projects, from simple python
                    tools to fancy web applications. Here are a few of my
                    favorites.
                  </p>
                </div>
              </div>
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 13}>
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                    Best Ideas Appear When a Deadline is Close
                  </h2>
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    During my time, I attended {DATA.hackathons.length}+ hackathons.
                    People from around the country would come together and build
                    incredible things in a short amount of time. It was eye-opening
                    to see the endless possibilities brought to life when we are
